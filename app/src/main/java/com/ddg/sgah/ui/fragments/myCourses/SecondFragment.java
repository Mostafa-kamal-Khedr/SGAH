    ...
    private void inflateCourses() {
        ...
        if (userName1 != null) {
            if (userName1.equals("maryam")) {
                ...
                List<HomeListModel> getsem2CommunicationStudyPlan = CoursesDb.getsem2CommunicationStudyPlan();
                rcCourses.setAdapter(new StudyPlanAdapter(getsem2CommunicationStudyPlan,getActivity()));


            } else {
                List<HomeListModel> getsem2ComputerStudyPlan = CoursesDb.getsem2ComputersStudyPlan();
                rcCourses.setAdapter(new StudyPlanAdapter(getsem2ComputerStudyPlan,getActivity()));
