 ...
 */
public class A4StudyPlanFragment extends Fragment {


    @BindView(R.id.rc_study_plan)
    RecyclerView rcStudyPlan;
    public A4StudyPlanFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflate = inflater.inflate(R.layout.fragment_a4_study_plan, container, false);
    ...
    private void inflateRecycler() {
        ...
        if (userName1 != null) {
            ...
            String[] allCommunicationStudyPlan = getResources().getStringArray(R.array.studyPlanListSem4Communication);
            rcStudyPlan.setAdapter(new StudyPlanAdapter2(allCommunicationStudyPlan));


        } else {
            String[] allComputersStudyPlan = getResources().getStringArray(R.array.studyPlanListSem4Computer);
