 ...
 */
public class A5StudyPlanFragment extends Fragment {

    @BindView(R.id.rc_study_plan)
    RecyclerView rcStudyPlan;

    public A5StudyPlanFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflate = inflater.inflate(R.layout.fragment_a5_study_plan, container, false);
    ...
    private void inflateRecycler() {
        ...
        if (userName1 != null) {
            if (userName1.equals("maryam")) {
                String[] allCommunicationStudyPlan = getResources().getStringArray(R.array.studyPlanListSem5Communication);
                rcStudyPlan.setAdapter(new StudyPlanAdapter2(allCommunicationStudyPlan));


            } else {
                String[] allComputersStudyPlan = getResources().getStringArray(R.array.studyPlanListSem5Computer);
