 ...
 */
public class FifthSemesterFragment extends Fragment {

    @BindView(R.id.rc_courses)
    RecyclerView rcCourses;

    public FifthSemesterFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflate = inflater.inflate(R.layout.fragment_fifth_semester, container, false);
    ...
    private void inflateCourses() {
        ...
        if (userName1 != null) {
            if (userName1.equals("maryam")) {
                ...
                List<HomeListModel> getsem5CommunicationStudyPlan = CoursesDb.getsem5CommunicationStudyPlan();
                rcCourses.setAdapter(new StudyPlanAdapter(getsem5CommunicationStudyPlan,getActivity()));


            } else {
                List<HomeListModel> getsem5ComputerStudyPlan = CoursesDb.getsem5ComputersStudyPlan();
                rcCourses.setAdapter(new StudyPlanAdapter(getsem5ComputerStudyPlan,getActivity()));
