 ...
 */
public class A1StudyPlanFragment extends Fragment {
    @BindView(R.id.rc_study_plan)
    RecyclerView rcStudyPlan;

    public A1StudyPlanFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflate = inflater.inflate(R.layout.fragment_a1_study_plan, container, false);
    ...
    private void inflateRecycler() {
        ...
        if (userName1 != null) {
            ...
            String[] allCommunicationStudyPlan = getResources().getStringArray(R.array.studyPlanListSem1Communication);
            rcStudyPlan.setAdapter(new StudyPlanAdapter2(allCommunicationStudyPlan));


        } else {
            String[] allComputersStudyPlan = getResources().getStringArray(R.array.studyPlanListSem1Computer);
