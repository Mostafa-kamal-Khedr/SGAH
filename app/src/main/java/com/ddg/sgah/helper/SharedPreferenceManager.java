...
public class SharedPreferenceManager {
    ...
    public void saveUserInfo( String userName, String email, String userPreference) {
        SharedPreferences.Editor myEditor = sharedPreferences.edit();

        myEditor.putString(USER_NAME, userName);
        myEditor.putString(USER_EMAIL, email);
        myEditor.putString(USER_Preference, userPreference);
    ...
    public void saveCategoryName(String categoryName) {
        ...
        myEditor.apply();
        myEditor.commit();
    }  public void saveUserName(String categoryName) {
        SharedPreferences.Editor myEditor = sharedPreferences.edit();
        myEditor.putString(USER_NAME, categoryName);
    ...
    public String loadUserPrefernce() {
